...
public class MyProfileActivity extends SwipeBackActivity{
    ...
    private List<SharesBean> mSharesBeanList = new ArrayList<>();
    ...
    private void initView(){
        ...
        Log.d("something", UserInfo.userAvatarUrl);
    ...
    protected void onRestart() {
        super.onRestart();
        NetworkUtils.initPicture(MyProfileActivity.this,UserInfo.userAvatarUrl
                ,mImvProfilePhoto,
                mUpLoadingLayout);
    }
